    ...
    <div className="min-h-screen grid grid-cols-1 gap-7 name content-center text-center">
      ...
      >
        ...
        <Typewriter
          options={{
            strings: [
              "✋I'm Khalid Mihlar, an enthusiastic Software Developer",
              "I'm a Masters Student studying Computer Science at UCSB",
              "I'm' specializing in cloud/network engineering",
